...
<head>
    ...
    <style>
        ...
        #menu ul li a:hover, s#menu ul li a.selected
        {
...
if(!empty($_GET['PageName']))
{
    ...
    unset($PagesFolder[0],$PagesFolder[1]); //delete array's 0 and 1 because they were . and ..
...
?>
    ...
    <section class="links">
	   ...
	   <br>
        ...
        <!-- Footer Area -->
        <div id="footer"><hr><p>Theme By | Ravindu Madushan | &copy;2021 All right reserved.
	<br><hr>
